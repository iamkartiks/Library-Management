...
def getAllRoutes():
    ...
    result = []
    result.append({'Books By Name or a Term in Name':'http://127.0.0.1:5000/book-by-term/<term>', 
    'BOOKS BY AUTHOR NAME':'http://127.0.0.1:5000/book-by-author/<authorname>',
    'BOOKS BY VARIOUS COMSTRAINTS':'http://127.0.0.1:5000/book-by-constraints/<term>/<authorname>/<low>/<high>',
    'TO ISSUE BOOK':'http://127.0.0.1:5000/issue-book',
    'TO RETURN BOOK':'http://127.0.0.1:5000/return-book',
    'BOOK ISSUED STATUS':'http://127.0.0.1:5000//book-issue-list/<bookname>',
    'BOOKS ISSUED BY PARTICULAR LEARNER':'http://127.0.0.1:5000/reader-issue/<lender>',
    'TOTAL RENT GENERATED BY A BOOK':'http://127.0.0.1:5000/total-rent/<bookname>',
    'BOOKS ISSUED IN GIVEN DATE RANGE':'http://127.0.0.1:5000/books-issued-in-daterange/<ldate>/<hdate>'
     })
